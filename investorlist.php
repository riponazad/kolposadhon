...
<div class="pageheader jumbotron">
  <div class="container">
    <h4 style="margin: 12px 2px 12px 2px;"><span id="roundborder">   বিনিয়োগকারীর তালিকা</span></h4>
  </div>	
</div>
...
<div class="primay-menu header">
  <div class="container">
    <nav class="navbar navbar-expand-lg navbar-dark justify-content-center" style="padding: 0px 0px 0px 0px;">
      <ul class="navbar-nav">
...
$sql = "SELECT name, address, amount, duration, email FROM investors NATURAL JOIN users";
